...
def draw_window(robot, left_speed, right_speed):
    WIN.blit(WHITE, (0, 0))
...
while(True):
    ...
    print("#############################################")
    print(f"Encoder 1 :{Robot.ticks_left}")
    print(f"Encoder 2 :{Robot.ticks_right}")

    prev_encoder1_value = Robot.ticks_left
    prev_encoder2_value = Robot.ticks_right

    draw_window(Robot, left_speed, right_speed, Robot.ticks_left, Robot.ticks_right)
    localisation(Robot, Robot.ticks_left, Robot.ticks_right)
    sleep(0.1)
