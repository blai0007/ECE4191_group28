...
class robot : 
    def __init__(self) : 
        ...
        self.m_per_tick = 32/720 #(1000 / 10400) / 10        #cm                    # Nathan and Bryan checked this, measure again if unsure
        self.ticks_per_full_rotation = 1750 #3659 # revs per 360*ticks per rev #3600 #1800 # 7500 #700  
