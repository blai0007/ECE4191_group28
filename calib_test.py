...
expected_ticks_per_iter = 1400 #expected_rpm * (900*dt/60) * 5
...
try:
    for i in range(100):
        ...
        # Plotting the values
        plt.subplot(1, 2, 1)
        plt.plot(i, left_ticks_iter, marker='o', linestyle='-')  # Plot using k as x-axis
        ...
        plt.subplot(1, 2, 2)
        plt.plot(i, right_ticks_iter, marker='o', linestyle='-')  # Plot using k as x-axis
        plt.axhline(y=expected_ticks_per_iter, color='r', linestyle='-')
